        ...
        id="Home">
          ...
          ">
            ...
            ">
              ...
              ">OLÁ, EU SOU LEVI DUARTE</h1>
              <p className="text-center text-xl max-md:text-lg">Como um Desenvolvedor Web iniciante orientado a resultados, meu foco é não apenas na funcionalidade do site, mas também em como ele pode contribuir para o sucesso geral do produto.</p>
              <a href="#Projeto" className=" w-[25%] h-12 flex items-center justify-center rounded-lg bg-[#af753f] transition-all hover:scale-105 hover:bg-[#da9c62] font-bold tracking-wider text-white no-underline
