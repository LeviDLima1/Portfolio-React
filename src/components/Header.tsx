  ...
  return (
    <>
      ...
      >
        ...
        <button
          onClick={handleShow}
          className=" w-[25%] h-12 flex items-center justify-center rounded-lg bg-[#af753f] transition-all hover:scale-105 hover:bg-[#da9c62] font-bold tracking-wider text-white md:hidden"
        >
          Launch
        </button>
