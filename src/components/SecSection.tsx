export default function SecSection() {
  return (
    <>
      <main
        className="bg-bg-section3 bg-no-repeat bg-cover flex flex-col items-center justify-center gap-20 max-md:gap-6
      ...
      >
        ...
        >
          ...
          >
            ...
            <p className="text-xl text-[#FFF1E2] max-md:text-sm">
              ...
              <a
                ...
                target="_blank"
                className="underline text-[#ffb671]"
              >
                Instagram
              </a>
            </p>
          ...
          <div
            ...
            "
          >
            <h1 className="text-5xl font-semibold max-md:text-2xl">
              MINHAS HABILIDADES
            </h1>
