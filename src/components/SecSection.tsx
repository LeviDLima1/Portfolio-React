export default function SecSection() {
    ...
    return (
      <>
        <main className="bg-bg-section3 bg-no-repeat bg-cover  flex flex-col items-center justify-center gap-20 max-md:gap-6
        
        md:h-screen max-md:pt-20 max-md max-md:px-4 max-md:pb-10
        "
        id="Sobre-Mim">
          <section className="w-1/2 max-md:w-full">
            ...
            ">
                ...
                <p className="text-xl max-md:text-lg max-md:text-justify">Aqui você encontrará mais informações sobre mim, o que eu faço e minhas habilidades atuais, principalmente em termos de programação e tecnologia.</p>
            </div>
          </section>
          ...
          ">
            ...
            ">
              <h1 className="text-5xl font-semibold text-[#FFF1E2]
              ...
              <button type="button" className=" w-[25%] h-12 rounded-lg bg-[#af753f] transition-all hover:scale-105 hover:bg-[#da9c62] font-bold tracking-wider
            ...
            ">
              <h1 className="text-5xl font-semibold max-md:text-2xl">MINHAS HABILIDADES</h1>
