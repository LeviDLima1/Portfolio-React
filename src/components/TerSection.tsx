...
export default function TerSection() {
    ...
    return (
    <>
    <main className="h-screen bg-gray-950 flex flex-col items-center justify-center bg-bg-section2 bg-cover bg-no-repeat gap-10"
    id="Projeto">
        ...
        <section className="w-full flex flex-col items-center justify-center gap-10">
            <div className="flex w-1/2 items-center justify-center">
                <div className="flex w-1/2 items-center justify-center"><a href="https://bulma-css-work.vercel.app"><img src={projetoBulma} alt="Bulma" className="rounded-xl hover:scale-[103%] transition-all"/></a></div>
                <div className="flex flex-col w-1/2 gap-6 text-[#FFF1E2]">
                    ...
                    <a href="https://bulma-css-work.vercel.app" className="w-[25%] h-12 rounded-lg bg-[#af753f] font-bold tracking-wider flex items-center justify-center hover:scale-[105%] hover:bg-[#da9c62] transition-all">Visitar</a>
                </div>
            </div>

            <div className="flex w-1/2 items-center justify-center">
                <div className="flex w-1/2 items-center justify-center"><a href="https://huggle.vercel.app"><img src={projetoHuddle} alt="Bulma" className="rounded-xl hover:scale-[103%] transition-all"/></a></div>
                <div className="flex flex-col w-1/2 gap-6 text-[#FFF1E2]">
                    ...
                    <a href="https://huggle.vercel.app" className="w-[25%] h-12 rounded-lg bg-[#af753f] font-bold tracking-wider flex items-center justify-center hover:scale-[105%] hover:bg-[#da9c62] transition-all">Visitar</a>
                </div>
            </div>
        </section>
    </main>
